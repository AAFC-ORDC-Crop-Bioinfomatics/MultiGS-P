# omniGS/preprocess/representations/haplotype.py
...
import numpy as np
import pandas as pd
from omniGS.preprocess.loaders import load_vcf
from omniGS.preprocess.processors import intersect_and_order_snps
